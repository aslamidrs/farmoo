...
export default function HeaderContainer() {
  ...
  const { setUser, notifications } = useAppContext();
  const navigate = useNavigate();

  console.log(notifications, "nofications")
      ...
      <header className="fixed w-full top-0 shadow-sm z-10 flex flex-col gap-2 py-4 px-2 mb-4 bg-white">
        <div className="flex justify-between items-center px-4">
          <div className="flex items-center gap-4">
            ...
            <h1
              onClick={() => navigate("/protected/landing")}
          ...
          <div className="flex gap-x-4">
            <div className="relative">
              <div className="-top-2 -left-2 absolute bg-primary w-4 h-4  rounded-full flex justify-center items-center">
        ...
        {window.location.pathname === "/protected/ai" ? null : (
